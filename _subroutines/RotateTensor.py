...
def RotateTensor(array,rot,rotm,ne,dof,ndi,nshr,ntens,nf,dir,voigt=1,eng=0):
    """
    ...
    if len(array.shape) == 3:
        array = _subroutines.VoigtToTensor(array,ne,dof,ndi,nshr,ntens,nf,eng)
    ...
    if voigt:
        arrayR = _subroutines.TensorToVoigt(arrayR,ne,ndi,ntens,nf,eng)
